...
class_model2_10 <- class_model2_pred %>% 
  filter(pctpov == 10)


ggplot() +
  geom_ribbon(class_model2_10, aes(x = pcthisp, y = p, ymin = p_lwr, ymax = p_upr), alpha = 0.2) +
  geom_line(class_model2_10, aes(x = pcthisp, y = p))
